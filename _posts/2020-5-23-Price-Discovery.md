...
I applied price discovery algorithms to 5 Min OHLCV data from Bitmex and CME contracts and Bitstamp, Coinbase, HitBTC, Kraken, Poloniex, Binance, and OkEx BTCUSD/BTCUSDT markets from March 2016 to May 2020 to find the leading bitcoin exchanges and how their role correlate with Bitcoin Price Direction. <!--more--> Some exciting observations I made are:
